...
let OrderDetails = class OrderDetails {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => String }, price: { required: true, type: () => Number }, order_id: { required: true, type: () => require("../../orders/entities/order.entity").Orders }, products: { required: true, type: () => [require("../../products/product.entity").Product] } };
    }
};
